<%@ Page Title="五金配件商城" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Default" %>
        ...
        <div class="layui-col-lg8">
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                    ...
                    <li><asp:LinkButton ID="BtnCategoryId_1" runat="server" OnClick="BtnCategoryId_1_Click">家具配件</asp:LinkButton></li>
                    <li><asp:LinkButton ID="BtnCategoryId_2" runat="server" OnClick="BtnCategoryId_2_Click">服装配件</asp:LinkButton></li>
                    <li><asp:LinkButton ID="BtnCategoryId_3" runat="server" OnClick="BtnCategoryId_3_Click">门窗配件</asp:LinkButton></li>
                    <li><asp:LinkButton ID="BtnCategoryId_4" runat="server" OnClick="BtnCategoryId_4_Click">通用配件</asp:LinkButton></li>
                    <li><asp:LinkButton ID="BtnCategoryId_5" runat="server" OnClick="BtnCategoryId_5_Click">五金工具</asp:LinkButton></li>
                </ul>
            </div>
        </div>
        <!--商品搜索框-->
