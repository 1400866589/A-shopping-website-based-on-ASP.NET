...
namespace HardwareAccessoriesShop.DAL
{
	...
	public partial class HardwareAccessoriesShopDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteCategory(Category instance);
		...
		public HardwareAccessoriesShopDataContext() : 
				base(global::HardwareAccessoriesShop.DAL.Properties.Settings.Default.Test5ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public HardwareAccessoriesShopDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HardwareAccessoriesShopDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HardwareAccessoriesShopDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HardwareAccessoriesShopDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class CartItem : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Accessories> _Accessories;
    ...
    partial void OnProQtyChanged();
		...
		public CartItem()
		{
			...
			this._Accessories = default(EntityRef<Accessories>);
			OnCreated();
		}
		...
		public int AccId
		{
			...
			set
			{
				...
				{
					if (this._Accessories.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Accessories_CartItem", Storage="_Accessories", ThisKey="AccId", OtherKey="AccId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Accessories Accessories
		{
			get
			{
				return this._Accessories.Entity;
			}
			set
			{
				Accessories previousValue = this._Accessories.Entity;
				if (((previousValue != value) 
							|| (this._Accessories.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Accessories.Entity = null;
						previousValue.CartItem.Remove(this);
					}
					this._Accessories.Entity = value;
					if ((value != null))
					{
						value.CartItem.Add(this);
    ...
    partial void OnListPriceChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccName", DbType="NVarChar(80)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Accessories_Collections", Storage="_Accessories", ThisKey="AccId", OtherKey="AccId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Accessories Accessories
		{
			get
			{
    ...
    partial void OnCommentStateChanging(int value);
    partial void OnCommentStateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CommentState", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Accessories_Comment", Storage="_Accessories", ThisKey="AccId", OtherKey="AccId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Accessories Accessories
		{
			get
			{
    ...
    partial void OnCourierNumChanging(string value);
    partial void OnCourierNumChanged();
    ...
    partial void OnOrderStateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CourierNum", DbType="NVarChar(80)")]
		public string CourierNum
		{
			get
			{
				return this._CourierNum;
			}
			set
			{
				if ((this._CourierNum != value))
				{
					this.OnCourierNumChanging(value);
					this.SendPropertyChanging();
					this._CourierNum = value;
					this.SendPropertyChanged("CourierNum");
					this.OnCourierNumChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_OrderState", DbType="Int NOT NULL")]
    ...
    partial void OnAccImageChanging(string value);
    partial void OnAccImageChanged();
    partial void OnAccDescnChanging(string value);
    partial void OnAccDescnChanged();
    partial void OnListPriceChanging(System.Nullable<decimal> value);
    partial void OnListPriceChanged();
    ...
    partial void OnAccStateChanging(int value);
    partial void OnAccStateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Producer", DbType="NVarChar(80)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Manufacturer", DbType="NVarChar(80)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Batch", DbType="NVarChar(80)")]
		public string Batch
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccImage", DbType="NVarChar(80)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccDescn", DbType="NVarChar(255)")]
		public string AccDescn
		{
			get
			{
				return this._AccDescn;
			}
			set
			{
				if ((this._AccDescn != value))
				{
					this.OnAccDescnChanging(value);
					this.SendPropertyChanging();
					this._AccDescn = value;
					this.SendPropertyChanged("AccDescn");
					this.OnAccDescnChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccDate", DbType="DateTime NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccState", DbType="Int NOT NULL")]
		public int AccState
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Accessories_CartItem", Storage="_CartItem", ThisKey="AccId", OtherKey="AccId")]
		public EntitySet<CartItem> CartItem
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Accessories_Collections", Storage="_Collections", ThisKey="AccId", OtherKey="AccId")]
		public EntitySet<Collections> Collections
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Accessories_Comment", Storage="_Comment", ThisKey="AccId", OtherKey="AccId")]
		public EntitySet<Comment> Comment
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Category_Accessories", Storage="_Category", ThisKey="CategoryId", OtherKey="CategoryId", IsForeignKey=true)]
		...
		{
			this.SendPropertyChanging();
			entity.Accessories = this;
		}
		
		private void detach_CartItem(CartItem entity)
		{
			this.SendPropertyChanging();
			entity.Accessories = null;
		}
    ...
    partial void OnCategoryStateChanging(int value);
    partial void OnCategoryStateChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CategoryState", DbType="Int NOT NULL")]
		public int CategoryState
		{
			...
			set
			{
				if ((this._CategoryState != value))
				{
					this.OnCategoryStateChanging(value);
					this.SendPropertyChanging();
					this._CategoryState = value;
					this.SendPropertyChanged("CategoryState");
					this.OnCategoryStateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Category_Accessories", Storage="_Accessories", ThisKey="CategoryId", OtherKey="CategoryId")]
